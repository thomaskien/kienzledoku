...
on run
    display dialog "Kienzledoku 1.3.0 ist installiert. Die Anwendung wird aus T2med über T2demo:// bzw. kienzledoku:// gestartet." buttons {"OK"} default button "OK"
end run
...
/usr/libexec/PlistBuddy -c "Add :CFBundleVersion string 1.3.0" "$PLIST"
