...
on run
    display dialog "Kienzledoku 1.3.1 ist installiert. Die Anwendung wird aus T2med über T2demo:// bzw. kienzledoku:// gestartet." buttons {"OK"} default button "OK"
end run
...
/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 1.3.1" "$PLIST"
/usr/libexec/PlistBuddy -c "Delete :CFBundleVersion" "$PLIST" >/dev/null 2>&1 || true
/usr/libexec/PlistBuddy -c "Add :CFBundleVersion string 1.3.1" "$PLIST"
